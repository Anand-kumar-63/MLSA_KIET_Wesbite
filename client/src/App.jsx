...
const Main_sidebar = lazy(
  () => import("./components/sidenav/main_sidebar.jsx"),
);
const AboutUs = lazy(() => import("./components/About/about.jsx"));
const EventPage = lazy(() => import("./components/Events/EventPage.jsx"));
const EventInfoPage = lazy(
  () => import("./components/Events/EventInfoPage.jsx"),
);
const EventPastPage = lazy(
  () => import("./components/Events/EventPastPage.jsx"),
);
...
function App() {
  return (
    <MainContextProvider>
      <AuthProvider>
        <Router>
          <div className="bg-[#1F2937] scroll-smooth">
            <Suspense
              fallback={
            ...
            >
              ...
              <Routes>
                ...
                />
                <Route
                  path="/upcoming-event-info/:evId"
                  element={
                    <>
                      <EventDetailsPage isUpcoming={true} />
                      <Mainfooter />
                    </>
                  }
                />
