  ...
  const EventPastPage = () => {
    ...
    return (
      <div className="flex min-h-screen overflow-x-hidden bg-[#1F2937]">
        <Main_sidebar className="mr-8" />
        <div className="flex-1 p-4">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#0078D4] text-center mt-6 mb-12">
            {event.name}
          </h1>
          <div className="flex flex-col lg:flex-col items-center justify-center w-full">
            ...
            <div className="w-full px-4 lg:px-0">
              <h2 className="text-3xl sm:text-3xl md:text-4xl text-center font-bold mb-4 text-[#0078D4] mt-8">
                Event Description
              </h2>
              ...
              <div className="flex items-center justify-center lg:justify-center">
                <FontAwesomeIcon
                  icon={faPeopleGroup}
                  className="mr-2 text-[#0078D4] text-2xl sm:text-3xl md:text-4xl"
                />
                <span className="text-[#0078D4] text-xl sm:text-2xl md:text-3xl font-bold">
                  {event.attendeeCount} Students Registered
                </span>
              </div>
            </div>
          </div>
          <h2 className="text-2xl sm:text-3xl md:text-4xl text-left font-bold mb-8 text-[#0078D4] mt-16 ml-4 md:ml-24">
            Event Images
          </h2>
          <div className="relative w-full flex flex-col items-center">
            <div className="flex items-center justify-center mb-4">
              <button
                className="bg-[#0078D4] hover:bg-[#005A9E] text-white font-bold py-2 px-4 rounded-l transition-colors"
                onClick={handlePrevClick}
              >
                <FontAwesomeIcon icon={faChevronLeft} />
              </button>
              <button
                className="bg-[#0078D4] hover:bg-[#005A9E] text-white font-bold py-2 px-4 rounded-r transition-colors"
            ...
            <div className="overflow-hidden flex justify-center w-full lg:w-3/4">
              <div
                ref={sliderRef}
                className="flex flex-no-wrap justify-center w-full"
              >
