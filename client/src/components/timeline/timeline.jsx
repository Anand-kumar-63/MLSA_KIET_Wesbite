...
function Line2() {
  ...
  return (
    <>
      ...
      <div className="">
        <div
          className={` bg-transparent ${scrollValue} absolute left-[49%] w-[20px] h-[1090px] top-[255%] `}
        >
...
function Timeline() {
  ...
  return (
    <>
      <div className="bg-[#1F2937] mt-0 h-full w-full md:h-full md:w-full lg:h-full lg:w-full xl:h-full xl:w-full  2xl:h-full 2xl:w-full">
        <Motion.h1
